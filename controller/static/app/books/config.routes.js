			    ...
			    templateUrl: 'app/books/books.html',
                        ...
                        .state('dashboard.addBook', {
                            ...
                            resolve: {
                                ...
                                statuses: ['BooksService', '$state', '$stateParams', function (BooksService, $state, $stateParams) {
                                    return BooksService.statuses().then(null, function(errorData) {
                                        $state.go('error');
                                    });
                                }],
                                accounts: ['BooksService', '$state', '$stateParams', function (BooksService, $state, $stateParams) {
                                    return BooksService.accounts().then(null, function(errorData) {
                                        $state.go('error');
                                    });
                                }] 
                            }
